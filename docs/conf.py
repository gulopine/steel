# -*- coding: utf-8 -*-
#
# Biwako documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Biwako.tex', u'Biwako: File Formats Made Easy',
...
man_pages = [
    ('index', 'biwako', u'Biwako: File Formats Made Easy',
     [u'Marty Alchin'], 1)
]
